...
// Get latest articles (limit to 6 for homepage)
try {
    $stmt = $pdo->query("SELECT a.*, c.name as category_name FROM articles a LEFT JOIN categories c ON a.category = c.name ORDER BY a.created_at DESC LIMIT 6");
...
<div class="hero">
    <h2>Welcome to MadridKH</h2>
    <p>Your ultimate source for Real Madrid news in English and Khmer</p>
